...
function checkConnectionOffline() {
  ...
  if (networkState === Connection.NONE) {
    swal({
      ...
      animation: false,
      text:
        "No cuentas con conexión a internet, para esta aplicación es necesaria la conexión, intenta de nuevo",
...
function consumedPoints() {
  $.ajax({
    ...
    success: function success(resp) {
      $("#p_cons").html(
        resp.puntos + "" == "null" ? "0" : resp.puntos + " pts."
      );
    },
...
function authentication() {
  ...
  if (
    ...
    $("#alertaLogin")
      .html(
        '<i class="fa fa-warning fa-lg"></i>&nbsp;Debes escribir tu contraseña'
      )
      .show();
  } else {
    var doAjax = (function() {
...
function changePassword() {
  var email = $("#email")
    .val()
    .trim();
  var valida_email = /^[-\w.%+]{1,64}@(?:[A-Z0-9-]{1,63}\.){1,125}[A-Z]{2,63}$/i;

  if (email == "") {
    $("#alertaLogin")
      .html('<i class="fa fa-warning fa-lg"></i>&nbsp;Debes escribir tu email')
      .show();
      ...
      success: function success(resp) {
        swal({
          ...
          if (resp.error == "") {
            ...
            $("#alertaLogin")
              .html('<i class="fa fa-warning fa-lg"></i>&nbsp;' + resp.error)
              .show();
          }
        });
      },
...
function register() {
  ...
  if (!$("#politicas")[0].checked) {
    $("#alertaRegistro")
      .html(
        '<i class="fa fa-warning fa-lg"></i>&nbsp;Antes tienes que estar de acuerdo con las políticas de privacidad.'
      )
      .show();
  } else if (
    $("#nombre").val() == "" ||
    ...
    $("#alertaRegistro")
      .html(
        '<i class="fa fa-warning fa-lg"></i>&nbsp;Verifique que todos los campos estén llenos'
      )
      .show();
        ...
        swal({
          ...
          if (resp.error != "") {
            ...
            swal({
              ...
              text:
                "En breve recibirás un mail para activar tu cuenta y contraseña.",
...
function saveData() {
  ...
  if (!$("#politicas").is(":checked")) {
    ...
    $("#alertaRegistro")
      .html('<i class="fa fa-warning fa-lg"></i>&nbsp;Debes seleccionar sexo')
      .show();
  } else if ($("#txtCorreo").val() == "") {
    $("#alertaRegistro")
      .html('<i class="fa fa-warning fa-lg"></i>&nbsp;Debes ingresar el correo')
      .show();
  } else if ($("#txtTelefono").val() == "") {
    $("#alertaRegistro")
      .html(
        '<i class="fa fa-warning fa-lg"></i>&nbsp;Debes ingresar número de celular'
      )
      .show();
  } else if ($("#txtpass").val() == "") {
    $("#alertaRegistro")
      .html(
        '<i class="fa fa-warning fa-lg"></i>&nbsp;Debes ingresar la contraseña'
      )
      .show();
  } else if (
    $("#txtpass2").val() != "" &&
    ...
    $("#alertaRegistro")
      .html(
        '<i class="fa fa-warning fa-lg"></i>&nbsp;La contraseña no coincide'
      )
      .show();
  } else if (!valida_email.test(email)) {
    $("#alertaRegistro")
        ...
        swal({
          ...
          if (resp.error != "") {
            ...
            $.ajax({
              ...
              success: function success(respNext) {
                if (respNext.error != "") {
                  $("#alertaRegistro")
                    .html(
...
function estados() {
  $.ajax({
    ...
    success: function success(re) {
      for (var i = 0; i < re.length; i++) {
        $("#txtEstado").append(
          '<option value="' + re[i].id + '">' + re[i].nombre + "</option>"
        );
      }
    },
    error: function error(XMLHttpRequest, textStatus, errorThrown) {
...
function politicas() {
  swal({
    ...
    html:
      ...
      "De conformidad con lo establecido en la Ley Federal de Protección de Datos personales de los" +
      "particulares WIS MASTER MEXICO S.A. DE C.V; pone a su disposición el siguiente aviso de privacidad:" +
      "<br><br>" +
      "" +
      "WIS MASTER MEXICO S.A. DE C.V; es responsable del uso y protección de sus datos personales, en este" +
      "sentido y atendiendo las obligaciones legales establecidas en la Ley Federal de Protección de Datos" +
      "personales en posesión de los particulares, a través de este instrumento se informa a los titulares de" +
      "los datos, la información que de ellos se recaba y los fines que se le darán a dicha información." +
      "<br><br>" +
      "Además de lo anterior, informamos a Usted que WIS MASTER MEXICO S.A. DE C.V; tiene su domicilio" +
      "ubicado en: Av. Mariano Escobedo 366, quinto piso, Colonia Anzures, Código Postal 11590, " +
  ...
  swal({
    ...
    if (result.value) {
      swal({
        ...
        text:
          "Puedes hacer valida esta promoción presentando este mensaje a tu mesero.",
        type: "info",
        confirmButtonText: "Ir a página principal",
        animation: false,
        showLoaderOnConfirm: true,
    ...
    navigator.geolocation.getCurrentPosition(
      function(position) {
        ...
        setDataCountryAndState(latlng)
          ...
          .catch(function() {
            alert('reject setDataCountryAndState')
            reject();
          });
      },
      function(error) {
        alert('reject navigator')
        reject();
      },
      {
        maximumAge: 600000,
